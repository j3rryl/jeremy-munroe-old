        ...
        <ul className="text-justify">
          <li>
            <FontAwesomeIcon
              icon={faEnvelope}
              size="2x"
              className="f-icon email"
            />
            <a
              className="tracking-widest"
              href="mailto:jeremymunroe0@gmail.com"
              target="_blank"
          ...
          <li>
            <FontAwesomeIcon
              icon={faLinkedin}
              size="2x"
              className="f-icon linkedin"
            />
            <a
              className="tracking-widest"
              href="https://www.linkedin.com/in/jeremy-munroe-old-b5ab711a4/"
              target="_blank"
              rel="noopener noreferrer"
            >
              Linked In
          ...
          <li>
            <FontAwesomeIcon
              icon={faInstagram}
              size="2x"
              className="f-icon instagram"
            />
            <a
              className="tracking-widest"
              href="https://instagram.com/_warsie"
              target="_blank"
              rel="noopener noreferrer"
            >
              Instagram
