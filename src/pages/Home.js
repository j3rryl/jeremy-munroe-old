      ...
      <div className="home-page md:overflow-x-hidden w-full h-full bg-none">
        <div className="mx-5 h-full md:overflow-hidden md:m-10 relative inline-block md:flex items-center justify-around">
          ...
          <div className="px-5 md:h-2/5 md:w-2/5 m-auto border-none">
            ...
            <p className="text-justify tracking-widest">
              I am a Codaholic very much in love with anything which has 1s and
              0s. This has culminated an adventure I took to learn every
              possible language I can.
            </p>
          </div>
        </div>
        ...
        <div className="my-10 w-full h-full md:m-10 relative inline-block md:flex items-center justify-around">
          ...
          <div className="px-5 h-3/4 text-center md:h-2/3 md:w-1/2 m-auto">
            ...
            <button
              className="explore px-10 py-5 text-base my-8 mx-auto text-center h-fit w-fit"
              onClick={() => {
                navigate("/jeremy-munroe-old/about");
              }}
            >
              Read More
            </button>
        ...
        <div className="md:overflow-hidden my-10 w-full h-full md:m-10 relative inline-block md:flex items-center justify-center">
          ...
          <div className="px-5 h-3/4 text-center md:h-2/3 md:w-1/2 m-auto">
            ...
            <button
              className="explore px-10 py-5 text-base my-8 mx-auto text-center h-fit w-fit"
              onClick={() => {
                navigate("/jeremy-munroe-old/projects");
              }}
            >
              View All
            </button>
